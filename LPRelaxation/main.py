...
def main(datasetPath = "C:/Users/CiSTUP/Desktop/A-Branch-and-Price-Algorithm-for-VRPTW/dataset/50-customer-instances/r202.txt", SHOWFIG = False):
    # 初始化分支定界算法
    bp = BranchAndBound()
...
def BatchMain(folder_path="C:/Users/CiSTUP/Desktop/A-Branch-and-Price-Algorithm-for-VRPTW/dataset/50-customer-instances", banned_datasets=("c110_1","c101")):
...
if __name__ == "__main__":
    ...
    # 单数据集处理
    main(datasetPath="C:/Users/CiSTUP/Desktop/A-Branch-and-Price-Algorithm-for-VRPTW/dataset/50-customer-instances/r202.txt", SHOWFIG=True)
